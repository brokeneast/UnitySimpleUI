...
public class DialogManager : UIWidgetManager<Dialog, DialogOption>
{
    ...
    private readonly string alertDialogPath = "Assets/SimpleUI/Prefabs/Dialog/AlertDialog.prefab";
    private readonly string choiceDialogPath = "Assets/SimpleUI/Prefabs/Dialog/ChoiceDialog.prefab";
    private readonly string infoDialogPath = "Assets/SimpleUI/Prefabs/Dialog/InfoDialog.prefab";
